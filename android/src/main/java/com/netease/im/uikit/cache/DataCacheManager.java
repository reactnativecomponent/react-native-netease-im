...
import com.netease.im.uikit.common.framework.NimSingleThreadExecutor;
...
public class DataCacheManager {
    ...
    public static void buildDataCache() {
        ...
        accounts.add(LoginService.getInstance().getAccount());
        IMApplication.getImageLoaderKit().buildAvatarCache(accounts);
    }
